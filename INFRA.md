...
Última atualização: 2026-05-13 (sessão 5)
...
Leia meu INFRA em 
https://raw.githubusercontent.com/cognis-ia/infra/main/INFRA.md
 e configure o acesso SSH ao VPS com a chave em vps_key na pasta conectada. Usuário: openclaw, host: 217.77.10.26.
...
💜 Gabi	gabi	@BE_Gabi_bot	~/.openclaw/workspace-gabi	(backup pendente)
💚 Max	max	@BE_Max_bot	~/.openclaw/workspace-max	(backup pendente)
...
Starter Kit v2.5.6
Instalado em Rocky, Léo, BrIA, Gabi e Max. 19 skills cada:
...
Pendencias
OpenAI Codex OAuth - expira ~22 maio; tem refresh_token (provavel renovacao automatica). Monitorar perto do dia 22. Se falhar: SSH com TTY -> openclaw models auth login --provider openai-codex.
Skills Gabi e Max - Starter Kit v2.5.6 instalado em 2026-05-13 (19 skills cada + MAPA.md + memory/ + archive/ + content/). Faltam skills especificas da Bernardelli Ensino (Gabi: conteudo/Canva/vendas/lancamentos; Max: planejamento/copy/YouTube/dados).
Backups Gabi e Max - criar repositorios GitHub/workspace backups para workspace-gabi e workspace-max.
Heartbeat Rocky e Leo - ainda nao configurado (BrIA ja tem heartbeat; BrIA tambem supervisiona Gabi/Max via cron de VPS).
TOOLS.md migration - Rocky e Leo tem TOOLS.md legado; migrar para MAPAs por pasta.
Deletar bot antigo - @Clawdio_Bruno_bot no BotFather (Bruno faz manualmente: /deletebot).
Revisao de seguranca completa - etapa VPS concluida em 2026-05-12; pendente rotacao da chave OpenAI API exposta em historico Git.
